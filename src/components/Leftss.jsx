...
function Leftss({ id, title, points = [], image, reverse }) {
  return (
    <section
      id={id}
      className="relative bg-[#F3E9FB] from-purple-50 to-purple-100 py-20 px-6 lg:px-12 font-poppins"
    >
      <div
